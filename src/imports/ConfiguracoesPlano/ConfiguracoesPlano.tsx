import svgPaths from "./svg-3ghjcg5k2y";
...
function Heading() {
  return (
    <div className="content-stretch flex h-[35.996px] items-start relative shrink-0 w-full" data-name="Heading 1">
      <p className="flex-[1_0_0] font-['Barlow_Condensed:Bold',sans-serif] leading-[36px] min-w-px not-italic relative text-[#f2f2f2] text-[30px] tracking-[-0.75px]">CONFIGURAÇÕES</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute left-[16px] size-[15.996px] top-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_26_646)" id="Icon">
...
function Icon2() {
  return (
    <div className="absolute left-[16px] size-[15.996px] top-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_26_932)" id="Icon">
...
function Icon3() {
  return (
    <div className="absolute left-[16px] size-[15.996px] top-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_26_363)" id="Icon">
...
function Text() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15.996px] h-[269.59px] items-start left-0 pb-[0.833px] pt-[20.833px] px-[20.833px] rounded-[10px] top-[487.21px] w-[717.012px]" style={{ backgroundImage: "linear-gradient(159.394deg, rgba(232, 39, 26, 0.1) 0%, rgba(232, 39, 26, 0.05) 100%)" }} data-name="Container">
